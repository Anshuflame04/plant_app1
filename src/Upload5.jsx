      ...
      <div style={styles.card}>
        ...
        <div style={styles.cropSelectContainer}>
          ...
          <button
            ...
            style={{
              ...styles.cropButton,
              backgroundColor: selectedCrop === 'rice' ? '#4CAF50' : '#fff',
              color: selectedCrop === 'rice' ? '#fff' : '#4CAF50',
            }}
          >
            Rice
          </button>
          <button
            onClick={() => handleCropChange('wheat')}
            style={{
              ...styles.cropButton,
              backgroundColor: selectedCrop === 'wheat' ? '#4CAF50' : '#fff',
              color: selectedCrop === 'wheat' ? '#fff' : '#4CAF50',
            }}
          >
            Wheat
          </button>
          <button
            ...
            style={{
              ...styles.cropButton,
              backgroundColor: selectedCrop === 'apple' ? '#4CAF50' : '#fff',
              color: selectedCrop === 'apple' ? '#fff' : '#4CAF50',
            }}
          >
            Apple
          </button>
